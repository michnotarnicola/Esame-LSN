...
{
	return 1.0;
	//double mu= 0.786399, sigma= 0.612139;
...
double variationalWaveFunction_second(double v)
{
	return 0;
	//double mu= 0.786399, sigma= 0.612139;
	//return -1./pow(sigma,2) * variationalWaveFunction(v) + 1./pow(sigma,4) * ( pow((v-mu),2)* exp(-pow((v-mu),2)/(2*pow(sigma,2))) + pow((v+mu),2)* exp(-pow((v+mu),2)/(2*pow(sigma,2))) );
